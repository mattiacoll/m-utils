...
function forEachHTML(els, fn, scope) {
  for (var i = 0, numEls = els.length; i < numEls; i++) {
...
function addClass(el) {
  ...
  if (el.length === undefined) addClassEl.apply(void 0, [el].concat(classes));else {
    forEachHTML(el, function (currEl) {
      addClassEl.apply(void 0, [currEl].concat(classes));
    });
  }

  function addClassEl(elem) {
    for (var _len2 = arguments.length, remClass = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
      remClass[_key2 - 1] = arguments[_key2];
    }
...
function removeClass(el) {
  ...
  if (el.length === undefined) removeClassEl.apply(void 0, [el].concat(classes));else {
    forEachHTML(el, function (currEl) {
      removeClassEl.apply(void 0, [currEl].concat(classes));
    });
  }

  function removeClassEl(elem) {
    for (var _len4 = arguments.length, remClass = new Array(_len4 > 1 ? _len4 - 1 : 0), _key4 = 1; _key4 < _len4; _key4++) {
      remClass[_key4 - 1] = arguments[_key4];
    }
...
function getTopPos(el) {
  var topEl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.body;
...
export { addClass, addEvent, byClass, byId, forEachHTML, getElementIndex, getLeftPos, getTopPos, hasClass, nextFrame, query, queryAll, removeClass, removeEvent };
